document.getElementById('search-form').addEventListener('submit', async function (e) {
  ...
  const apiUrl = `https://api.travelpayouts.com/v2/prices/latest?origin=${fromCity}&destination=${toCity}&departure_at=${departureDate}&adults=${adults}&token=const API_KEY = 'f438ef847616d4e4229a56129f870ba2';
;
